...
?>
<div id="<?php esc_html_e( $id ); ?>-container"
	 class="yith-plugin-fw-metabox-field-row" <?php echo yith_field_deps_data( $args ); // phpcs:ignore?>>
	...
	echo sprintf( esc_html( '%1$s %2$s %3$s' ), $type_field, $value_fields, $symbol_field );
	?>
	<div class="clear"></div>
