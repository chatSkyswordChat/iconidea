...
<div id="<?php esc_attr_e( $id ); ?>-container" <?php echo yith_field_deps_data( $args ); //phpcs:ignore ?>
				...
				<div class="special-row">
					<div class="special-row-field">
						...
						/* translators:
							...
							*/
						echo sprintf( esc_html_x( 'If user purchases %1$s item(s) gets %2$s item(s) with %3$s %4$s %5$s', 'If user purchases 3 item(s) gets 2 item(s) with a discount of 30%', 'ywdpd' ), $from_fields, $to_fields, $type_discount_field, $amount_field, $symbol_field );
						?>
					</div>
				</div>
			</div>
