...
<div id="<?php echo esc_attr( $id ); ?>-container" <?php echo yith_field_deps_data( $args ); //phpcs:ignore ?>
	...
	<div class="yith-plugin-fw-field-wrapper">
		<div class="discount-table-rules-wrapper">
			<div class="discount-rules">
				...
				for ( $i = 1; $i <= $limit; $i ++ ) :
					...
					<div class="discount-table-row" data-index="<?php echo $i; ?>">
						...
						*/
						echo sprintf( esc_html__( 'Apply %1$s %2$s %3$s on all products of %4$s', 'ywdpd' ), $type_discount_field, $amount_field, $symbol_field, $product_cat_field );
						?>
						<?php
						if ( 1 !== $i ):
							?>
			...
			<div class="discount_new_rule">
				<a href="#" id="ywdpd_new_qty_cat_rule" class="ywdpd_new_rule"><?php _e( '+ Add rule', 'ywdpd' ); ?></a>
			</div>
		</div>
	...
	<div class="clear"></div>
	<span
		class="description"><?php esc_html_e( $desc ); ?></span>
</div>
