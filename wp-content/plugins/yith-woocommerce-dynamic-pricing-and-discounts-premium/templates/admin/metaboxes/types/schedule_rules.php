...
<div id="<?php echo esc_attr( $id ); ?>-container" <?php echo yith_field_deps_data( $args ); //phpcs:ignore ?>
	...
	<div class="yith-plugin-fw-field-wrapper">
		<?php
			echo yith_plugin_fw_get_field( $radio_args);
			?>
		<div class="yith-plugin-fw-field-schedule">
			<span class="from_datepicker">
				<label for="_schedule_from"><?php _e('From','ywdpd');?></label>
				<input type="text" id="_schedule_from" autocomplete="off" class="yith-plugin-fw-text-input" value="<?php echo $date_from;?>" name="<?php echo $name;?>[schedule_from]"/>
			<span class="yith-icon yith-icon-calendar2"></span>
			</span>

			<span class="to_datepicker">
				<label for="_schedule_to"><?php _e('To','ywdpd');?></label>
				<input type="text" id="_schedule_to" autocomplete="off" class="yith-plugin-fw-text-input" value="<?php echo $date_to;?>" name="<?php echo $name;?>[schedule_to]"/>
			<span class="yith-icon yith-icon-calendar2"></span>
			</span>
