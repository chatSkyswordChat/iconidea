...
<div class="wrap">
    ...
    <form method="post" action="options.php?uid=<?php if( isset($_GET['uid']) ) echo $_GET['uid']; ?>">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    foreach( $web_users as $user ) {
                        $selected = ( isset($_GET['uid']) && $_GET['uid'] == $user->ID) ? 'selected ="selected"' : '';
...
jQuery(document).ready(function($) {
    ...
    $('#user-id').on('change',function(){
        var uid = $(this).val();
        location.href = '<?php echo esc_url( admin_url('options-general.php?page=sig-wp-line-notify&uid=') ); ?>'+uid;
    });
