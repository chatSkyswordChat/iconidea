...
use FCFProVendor\Dotenv\Dotenv;
/**
 * Env.
 */
class Configuration
{
    ...
    {
        $dotenv = \FCFProVendor\Dotenv\Dotenv::createImmutable(\getcwd() . '/../');
        $dotenv->safeLoad();
        ...
        if (isset($configuration['plugin-slug'])) {
            ...
            throw new \FCFProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-slug setting!');
        }
        if (isset($configuration['plugin-file'])) {
            $plugin_file = $configuration['plugin-file'];
        } else {
            throw new \FCFProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-file setting!');
        }
        ...
        if (isset($configuration['plugin-title'])) {
            ...
            throw new \FCFProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-title setting!');
        }
