...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \FCFProVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\FCFProVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\FCFProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\FCFProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \FCFProVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_dir, \FCFProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\FCFProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \FCFProVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
