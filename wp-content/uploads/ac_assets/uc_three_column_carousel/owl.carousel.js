...
* Licensed under: SEE LICENSE IN https://github.com/owlCarouselUE2/owlCarouselUE2/blob/master/LICENSE
*/
/**
* Owl carousel 
* @version 2.3.5
		...
		*/
		Owl.prototype.trigger = function(name, data, namespace, state, enter) {
			var status = {
				...
				* @public
				*/
				$.fn.owlCarouselUE = function(option) {
				...
				* @public
				*/
				$.fn.owlCarouselUE.Constructor = Owl;
			...
			*/
			;(function($, window, document, undefined) {
				...
				*/
				...
				$.fn.owlCarouselUE.Constructor.Plugins.AutoRefresh = AutoRefresh;
			...
			*/
			;(function($, window, document, undefined) {
				...
				*/
				...
				$.fn.owlCarouselUE.Constructor.Plugins.Lazy = Lazy;
				...
				*/
				var AutoHeight = function(carousel) {
					...
					*/
					...
					$.fn.owlCarouselUE.Constructor.Plugins.AutoHeight = AutoHeight;
				...
				*/
				;(function($, window, document, undefined) {
					...
					*/
					...
					$.fn.owlCarouselUE.Constructor.Plugins.Video = Video;
				...
				*/
				;(function($, window, document, undefined) {
					...
					*/
					...
					$.fn.owlCarouselUE.Constructor.Plugins.Animate = Animate;
					...
					*/
					Autoplay.prototype._next = function(speed) {
						...
						*/
						...
						$.fn.owlCarouselUE.Constructor.Plugins.autoplay = Autoplay;
						...
						*/
						Navigation.prototype.onTrigger = function(event) {
							...
							*/
							...
							$.fn.owlCarouselUE.Constructor.Plugins.Navigation = Navigation;
						...
						*/
						;(function($, window, document, undefined) {
							...
							*/
							...
							$.fn.owlCarouselUE.Constructor.Plugins.Hash = Hash;
